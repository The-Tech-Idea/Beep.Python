...
namespace Beep.Python.Winform.Cpython
{
    public class MenuManager
    {
        
        public string searchtext { get; set; }  
        public ICPythonManager PythonManager { get; set; }
        ...
        public MenuManager(ICPythonManager pythonManager, Scintilla textArea)
        {
        ...
        public void SetupPipMenu(ToolStripMenuItem packagesToolStripMenuItem)
        {
            ...
            t.Click += iDEManager.Installpip_Click;
            t.Image = iDEManager.resourceManager.GetImage("Beep.Python.Winform.gfx.", "install.ico");

            ToolStripItem tupdate = packagesToolStripMenuItem.DropDownItems.Add("Update pip");
            tupdate.Click += iDEManager.updatePIP_Click;
            tupdate.Image = iDEManager.resourceManager.GetImage("Beep.Python.Winform.gfx.", "install.ico");
            t = packagesToolStripMenuItem.DropDownItems.Add("List Packages");
            t.Image = iDEManager.resourceManager.GetImage("Beep.Python.Winform.gfx.", "list.ico");
            t.Click += iDEManager.PackagesInstalledbutton_Click;
            ...
            foreach (string item in PythonManager.PIPManager.packages.Select(o => o.Category).Distinct().ToList())
            {
                ...
                foreach (PackageDefinition package in PythonManager.PIPManager.packages.Where(p => p.Category == item))
                {
                    ...
                    {
                        t.Image = iDEManager.resourceManager.GetImage("Beep.Python.Winform.gfx.", "nolink.ico");
                    }
                    t.Click += iDEManager.PackagesToolStripMenuItem_Click;
