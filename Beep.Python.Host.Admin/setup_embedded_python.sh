#!/bin/bash
# ============================================
# Beep.Python - Embedded Python Setup (Linux/macOS)
# ============================================
...
cat > python-embedded/.beep_protected << EOF
CRITICAL_SYSTEM_COMPONENT
This directory contains the embedded Python runtime required for Beep.Python to function.
