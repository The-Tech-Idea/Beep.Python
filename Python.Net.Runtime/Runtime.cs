...
namespace Python.Runtime
{
    ...
    public unsafe partial class Runtime
    {
        ...
        static int run = 0;
        public static string PythonRuntimePath { get; set; } = string.Empty;
        ...
        internal static void Initialize(bool initSigs = false)
        {
            ...
            {
                try
                { // Convert the string to IntPtr
                    IntPtr pythonHomePtr = Marshal.StringToHGlobalAnsi(PythonRuntimePath);

                    // Set the Python home
                   
           //         Py_SetPythonHome(pythonHomePtr);
                    Py_InitializeEx( 1);
                    NewRun();
                ...
                {
                    Console.Error.WriteLine($"Fatal: Python runtime could not be initialized.{ex.Message}");
                }
