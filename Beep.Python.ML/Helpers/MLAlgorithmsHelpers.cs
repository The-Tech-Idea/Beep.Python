...
namespace Beep.Python.ML.Helpers
{
    public static class MLAlgorithmsHelpers
    {
        private static readonly Dictionary<string, string> CustomAlgorithms = new();
        private static readonly Dictionary<MachineLearningAlgorithm, AlgorithmCategory> AlgorithmCategories =
               new()
               {
                { MachineLearningAlgorithm.RandomForestClassifier, AlgorithmCategory.Classification },
                { MachineLearningAlgorithm.LogisticRegression, AlgorithmCategory.Classification },
                { MachineLearningAlgorithm.SVM, AlgorithmCategory.Classification },
                { MachineLearningAlgorithm.KNN, AlgorithmCategory.Classification },
                { MachineLearningAlgorithm.DecisionTreeClassifier, AlgorithmCategory.Classification },
                { MachineLearningAlgorithm.GradientBoostingClassifier, AlgorithmCategory.Classification },
                { MachineLearningAlgorithm.AdaBoostClassifier, AlgorithmCategory.Classification },
                { MachineLearningAlgorithm.GaussianNB, AlgorithmCategory.Classification },
                { MachineLearningAlgorithm.MultinomialNB, AlgorithmCategory.Classification },
                { MachineLearningAlgorithm.BernoulliNB, AlgorithmCategory.Classification },
                { MachineLearningAlgorithm.LinearRegression, AlgorithmCategory.Regression },
                { MachineLearningAlgorithm.LassoRegression, AlgorithmCategory.Regression },
                { MachineLearningAlgorithm.RidgeRegression, AlgorithmCategory.Regression },
                { MachineLearningAlgorithm.ElasticNet, AlgorithmCategory.Regression },
                { MachineLearningAlgorithm.DecisionTreeRegressor, AlgorithmCategory.Regression },
                { MachineLearningAlgorithm.RandomForestRegressor, AlgorithmCategory.Regression },
                { MachineLearningAlgorithm.GradientBoostingRegressor, AlgorithmCategory.Regression },
                { MachineLearningAlgorithm.HistGradientBoostingRegressor, AlgorithmCategory.Regression },
                { MachineLearningAlgorithm.SVR, AlgorithmCategory.Regression },
                { MachineLearningAlgorithm.KMeans, AlgorithmCategory.Clustering },
                { MachineLearningAlgorithm.DBSCAN, AlgorithmCategory.Clustering },
                { MachineLearningAlgorithm.AgglomerativeClustering, AlgorithmCategory.Clustering }
               }; 
        private static readonly Dictionary<MachineLearningAlgorithm, bool> AlgorithmSupervision = new();

        /// <summary>
        /// Initializes the supervision status of each algorithm.
        /// </summary>
        public static void InitializeAlgorithmSupervision()
        {
            AlgorithmSupervision[MachineLearningAlgorithm.HistGradientBoostingRegressor] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.RandomForestClassifier] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.LogisticRegression] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.SVM] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.KNN] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.DecisionTreeClassifier] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.GradientBoostingClassifier] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.AdaBoostClassifier] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.GaussianNB] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.MultinomialNB] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.BernoulliNB] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.LinearRegression] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.LassoRegression] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.RidgeRegression] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.ElasticNet] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.DecisionTreeRegressor] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.RandomForestRegressor] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.GradientBoostingRegressor] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.SVR] = true;
            AlgorithmSupervision[MachineLearningAlgorithm.KMeans] = false;
            AlgorithmSupervision[MachineLearningAlgorithm.DBSCAN] = false;
            AlgorithmSupervision[MachineLearningAlgorithm.AgglomerativeClustering] = false;
        }
        public static void AddCustomAlgorithm(string algorithmName, string description, AlgorithmCategory category)
        {
            if (!CustomAlgorithms.ContainsKey(algorithmName))
            {
                CustomAlgorithms[algorithmName] = description;
                AlgorithmCategories.Add(Enum.Parse<MachineLearningAlgorithm>(algorithmName), category);
            }
        }
        public static List<string> GetAlgorithmsByCategory(AlgorithmCategory category)
        {
        ...
        {
            return Enum.GetNames(typeof(MachineLearningAlgorithm))
                       .Concat(CustomAlgorithms.Keys)
                       .ToList();
        }
        public static string GenerateAlgorithmDescription(MachineLearningAlgorithm algorithm)
        {
            switch (algorithm)
            {
                ...
                default:
                    return CustomAlgorithms.ContainsKey(algorithm.ToString())
                        ? CustomAlgorithms[algorithm.ToString()]
                        : "Unknown Algorithm";
            }
        }
